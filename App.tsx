    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <NavigationContainer>
        <Stack.Navigator>
          ...
          <Stack.Screen name='accountCreatedPopUp' component={AccountCreatedPopUpScreen} options={{presentation: 'fullScreenModal' , title: "", headerShown: false}} />
          <Stack.Screen name='checkMailPopUp' component={CheckMailPopUpScreen} options={{presentation: 'fullScreenModal', title: "", headerShown: false}} />
        </Stack.Navigator>
      </NavigationContainer>
